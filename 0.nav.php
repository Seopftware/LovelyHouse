        <nav class="navbar navbar-inverse navbar-fixed-top">
          <div class="container">
            <div class="navbar-header">
              ...
              <!-- <a class="navbar-brand" href="#">러블리 하우스</a> -->
            </div>
            <div id="navbar" class="navbar-collapse collapse">
              ...
              <form class="navbar-form navbar-right">
                <a href="javascript:popupOpen();"  class="btn btn-success">Log in</a>
                <a href="0.signup.php" target="_blank" class="btn btn-primary"> Sign up</a>
              </form>
            </div><!--/.navbar-collapse -->
