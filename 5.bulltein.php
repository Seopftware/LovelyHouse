...
<?php
		...
		if($page != 1) {
			$paging .= '<li class="page page_start"><a href="mainexam.php?5.bulltein.php?page=1' . $subString . '">처음</a></li>';
		}
		//첫 섹션이 아니라면 이전 버튼을 생성
		if($currentSection != 1) {
			$paging .= '<li class="page page_prev"><a href="mainexam.php?5.bulltein.php?page=' . $prevPage . $subString . '">이전</a></li>';
		}
		...
		for($i = $firstPage; $i <= $lastPage; $i++) {
			if($i == $page) {
				...
				$paging .= '<li class="page"><a href="5.bulltein.php?page=' . $i . $subString . '">' . $i . '</a></li>';
			}
		}

		//마지막 섹션이 아니라면 다음 버튼을 생성
		if($currentSection != $allSection) {
			$paging .= '<li class="page page_next"><a href="5.bulltein.php?page=' . $nextPage . $subString . '">다음</a></li>';
		}

		//마지막 페이지가 아니라면 끝 버튼을 생성
		if($page != $allPage) {
			$paging .= '<li class="page page_end"><a href="5.bulltein.php?page=' . $allPage . $subString . '">끝</a></li>';
		}
		$paging .= '</ul>';
...
<body>
	<article class="boardArticle">
		...
		<div id="boardList">
			...
			<div class="searchBox">
				<form action="5.bulltein.php" method="get">
