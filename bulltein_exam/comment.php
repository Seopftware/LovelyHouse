				...
				<div id="co_<?php echo $row['co_no']?>" class="commentSet">
					<div class="commentInfo">
						...
						<div class="commentBtn">
							<a href="/bulltein_exam/comment_update.php" class="comt write">댓글</a>
							<a href="/bulltein_exam/comment_update.php" class="comt modify">수정</a>
...
<form action="/bulltein_exam/comment_update.php" method="post">
	<input type="hidden" name="bno" value="<?php echo $bNo?>">
	<table>
		<tbody>
			<tr>
